...
//
// 2020/09/09 Revised by M.Odhiambo
//
using UnityEngine;
...
namespace UnityChan {
    ...
    public class UnityChanControlScript2 : MonoBehaviour {
        ...
        public Help joystick;
        public UIButtonController jumpButton;
        ...
        void FixedUpdate() {
            ...
            if (transform.parent.parent != null && (Input.GetButtonDown("Jump") || (jumpButton != null && jumpButton.GetButtonDown()))) {   // スペースキーを入力したら
            ...
            // 現在のベースレイヤーがidleStateの時
                ...
                if (transform.parent.parent != null && (Input.GetButtonDown("Jump") || (jumpButton != null && jumpButton.GetButtonDown()))) {
